param(
    ...
    [ValidateSet("", "internal-link-native", "phase3-events", "selection-payload", "relocation-payload", "page-box", "font-size", "font-size-publisher-styles", "chapter-progress-endpoints", "chapter-progress-current-endpoints")]
