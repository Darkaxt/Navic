...
const val ReaderDragAnimationNone = "none"
const val ReaderDragAnimationCanvas = "canvas"
...
fun normalizedReaderDragAnimationMode(dragAnimationMode: String?): String =
	when (dragAnimationMode?.trim()?.lowercase()) {
		ReaderDragAnimationCanvas, "curl" -> ReaderDragAnimationCanvas
...
fun defaultReaderSettings(): ReaderSettings =
	normalizedReaderSettings(
		...
		pageBitmapQuality = ReaderPageBitmapQuality.Balanced.persistedValue,
...
fun normalizedReaderSettings(
	...
	coverBackdropEnabled: Boolean = true,
	navBarType: String? = ReaderNavBarTypeVerticalRight,
	dragAnimationMode: String? = ReaderDragAnimationNone,
	pageBitmapQuality: String? = ReaderPageBitmapQuality.Balanced.persistedValue,
	...
	return ReaderSettings(
		...
		pageBitmapQuality = normalizeReaderPageBitmapQuality(pageBitmapQuality).persistedValue,
...
fun ReaderSettings.normalizedReaderSettings(): ReaderSettings =
	normalizedReaderSettings(
		...
		coverBackdropEnabled = coverBackdropEnabled ?: true,
