...
import navic.composeapp.generated.resources.action_clear_bindery_cache
...
import navic.composeapp.generated.resources.info_clear_bindery_cache_confirmation
...
enum class DangerZoneAction(
	...
	ClearLidaClipsVideoCache(
		Res.string.action_clear_lidaclips_video_cache,
		Res.string.info_clear_lidaclips_video_cache_confirmation
	),
	ClearBinderyCache(
		Res.string.action_clear_bindery_cache,
		Res.string.info_clear_bindery_cache_confirmation
	),
...
fun dangerZoneActions(): ImmutableList<DangerZoneAction> =
	persistentListOf(
		...
		DangerZoneAction.ClearBinderyCache,
