...
class PreferenceManager(
	...
	var readerFontSizePercent by preference(140)
	var readerLineHeightPercent by preference(180)
	...
	var readerFontWeight by preference(400f)
	var readerLetterSpacing by preference(0f)
	var readerWordSpacing by preference(0f)
	var readerSideMargin by preference(6f)
	var readerTopMargin by preference(90f)
	var readerBottomMargin by preference(50f)
	var readerTextIndent by preference(0f)
	var readerHeadingFontSize by preference(1f)
	var readerMaxColumnCount by preference(0)
	var readerColumnThreshold by preference(720f)
	...
	var readerPdfCropBorders by preference(false)
	var readerPdfPageGapPercent by preference(0)
	...
	var readerWhispersyncListeningEnabled by preference(true)
	var readerWhispersyncPlaybackSpeed by preference(1f)
	var readerWhispersyncHighlightLeadMs by preference(750)
	var readerWhispersyncHighlightColorArgb by preference(0x66F6C343)
	var readerWhispersyncHighlightLoading by preference("current-cue")
	var readerWhispersyncHighlightStyle by preference("selection")
	var readerWhispersyncPageBoundaryBehavior by preference("pause-at-visible-page-end")
	var readerWhispersyncLongPressBehavior by preference("seek-audio-to-text")
