...
class AurralRepository(
	...
	private val mutations = AurralMutationRepositoryActions(
		preferenceManager = preferenceManager,
		apiClient = apiClient,
		auth = auth,
		localState = localState,
		confirmationQueueManager = confirmationQueueManager,
		metadataCache = metadataCache,
		nowMillis = nowMillis,
		confirmationWorkerEnabled = confirmationWorkerEnabled
	)
