...
class ReaderRuntimePaperSurfaceTest {
	...
	fun portraitPaperCompositionDoesNotInheritLandscapeGeometry() {
		...
		assertContains(helperText, "profile?.bindingEdge === 'right'")
		assertContains(helperText, "inset -18px 0 24px -22px")
		...
		assertContains(appearanceText, "readerPhysicalPageSide({")
		assertContains(appearanceText, "this.pageTurnPreviewDecorationPageIndex")
		assertContains(appearanceText, "previewDecorationPageIndex != null")
		...
		assertContains(previewText, "this.pageTurnPreviewDecorationPageIndex = state.pageIndex")
		assertContains(previewText, "this.renderSurfacePaperTextureLayers()")
		assertContains(previewText, "this.pageTurnPreviewDecorationPageIndex = null")
