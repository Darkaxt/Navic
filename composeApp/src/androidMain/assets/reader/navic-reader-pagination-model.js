...
export const readerPaginationRenderState = input => ({
  ...
  adaptivePageBox: {
    maxInlineSize: String(input?.adaptivePageBox?.maxInlineSize || ''),
    maxBlockSize: String(input?.adaptivePageBox?.maxBlockSize || ''),
    maxColumnCount: String(input?.adaptivePageBox?.maxColumnCount || ''),
    columnThreshold: String(input?.adaptivePageBox?.columnThreshold || ''),
    foliateGap: String(input?.adaptivePageBox?.foliateGap || ''),
    foliateContentGap: String(input?.adaptivePageBox?.foliateContentGap || ''),
  },
