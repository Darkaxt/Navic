...
* Disabled or incomplete integrations are gated at navigation, screen, repository, and queue boundaries: their rows, route contents, loading indicators, and new background jobs are suppressed while settings and explicit cache-clear actions remain available.
