...
* Optional LidaClips integration for matching current Navidrome tracks to music-video clip streams, including Android Picture-in-Picture
...
Android plays the clip in-app through Media3. With Picture-in-Picture enabled, the video can stay visible when you leave Navic. iOS currently shows an unsupported message until a native video player is added.
