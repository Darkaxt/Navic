...
* Integration pulse strips render branded PNG assets instead of raw SVG resources through the Android painter path, and the Library pulse sits in the status/top-left overlay area instead of being pushed down into the content grid.
