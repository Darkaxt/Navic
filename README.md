...
* Android now-playing widgets refresh on song transitions as well as play/pause changes, and artwork-only MusicBrainz fallback updates force a widget refresh after the external artwork is resolved.
