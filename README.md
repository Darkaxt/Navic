...
* Integration pulse strips render from Android-safe vector icons, avoiding the crash caused by loading raw SVG resources through the Android painter path.
