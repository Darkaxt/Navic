...
* The native Aurral hub can create new Flows, enable or disable existing Flows, trigger a Flow run when the backend exposes the required permissions, and jump to the matching synced Navidrome `[A]` Station when one already exists locally.
