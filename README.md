...
* Library Aurral rows and the native Aurral Discover grid refresh through a fast discovery-only path, so recommendation collections are not hidden behind slower service-status diagnostics or missing-artwork hydration.
