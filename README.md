...
* Now-playing clip lookups are cached briefly and prefetched by LidaClips URL, API key/header set, and Navidrome song id, so backend sync changes can appear without restarting Navic.
