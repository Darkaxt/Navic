...
* Kreate-inspired Now Playing technical info style can keep the compact format/sample-rate/bitrate badge inside the title/artist metadata area or add source stats such as bit depth, channel count, file size, and ReplayGain.
