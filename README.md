...
* The Now Playing technical-info chip is rendered in the controls/progress stack instead of the artwork slot, so format/bitrate text no longer collides with square covers or rotating vinyl artwork. Landscape Now Playing also moves the collapse control into the track/action row beside star and more actions so it does not overlap the top-right buttons.
