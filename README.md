...
* The Now Playing technical-info chip keeps the existing square-cover placement, but rotating vinyl artwork shifts the chip below the disc edge so format/bitrate text does not sit on top of the record art.
