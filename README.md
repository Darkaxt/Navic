...
* LidaClips settings show backend service counts and can pause or resume scheduled backend clip syncs.
...
5. Review `Service status` to see active, official, and fallback clip counts. Use `Pause LidaClips sync` if you want the backend to stop scheduled clip processing.
