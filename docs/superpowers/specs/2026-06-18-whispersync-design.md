...
- The page-scoped Whispersync control is intentionally rendered as a low-opacity headset glyph on the paper layer, not as a circular Material badge, pill, or progress-ring chrome element.
