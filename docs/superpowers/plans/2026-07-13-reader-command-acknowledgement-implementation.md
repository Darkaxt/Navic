...
- Modify `androidApp/build.gradle.kts`: prepare `v1.0.11-iota13`, Android `versionCode=540`.
...
- [x] **Step 3: Implement the protocol types**
...
- [x] **Step 4: Re-run the focused protocol tests and confirm GREEN**
...
- [x] **Step 2: Run `ReaderWebCommandDispatchTest` and confirm RED**
...
- [x] **Step 3: Implement the immutable ledger**
...
- [x] **Step 4: Run the state-machine tests and confirm GREEN**

- [x] **Step 5: Adapt the Storyteller host test and commit**
...
- [x] **Step 1: Write a failing packaged-runtime contract test**
...
- [x] **Step 2: Run the focused host test and confirm RED**
...
- [x] **Step 3: Implement the JavaScript dispatcher**
...
- [x] **Step 4: Run the host test and confirm GREEN**

- [x] **Step 5: Commit Kotlin and JavaScript together**
...
- [x] **Step 1: Add a failing Android-host source contract**
...
- [x] **Step 3: Implement host integration**
...
- [x] **Step 4: Run protocol, ledger, asset, and host tests and confirm GREEN**
...
- [x] **Step 1: Run the complete owning suites and Android assembly**
...
- [x] **Step 2: Rebase onto the current public `master`**
...
- [x] **Step 3: Validate renderer recovery on Android**
...
- [x] **Step 4: Record B5/B24 evidence and prepare only `iota13`**

Update both QA documents with test/device evidence. Set `androidApp/build.gradle.kts` to `v1.0.11-iota13` and Android `versionCode=540`; inspect the diff to ensure no `kappa` or `lambda` version is introduced.
